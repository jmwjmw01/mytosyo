...
(function() {
  $(document).on('ready page:load', function() {
    ...
    $('#book_isbn').keydown(function() {
      var presskey;
      presskey = String.fromCharCode(event.keyCode);
      return event.returnValue = /[0-9\b\t\n]/.test(presskey);
    });
...
var chara_door = new Array("door_kuma.png", "door_usagi.png", "door_neko.png", "door_risu.png");
window.onload = function () {
    var $door_img = document.getElementById( "door_img" );
    $door_img.src = "door.png";
